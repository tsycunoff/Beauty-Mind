...
const AnimatedCounter = ({
  ...
  return (
    <span className="tabular-nums">
      {prefix}{count === end && suffix === '%' && end === 74 ? '74' : count}{suffix}
    </span>
  );
};
    ...
    >
      <div 
        className={`relative bg-white rounded-xl p-6 md:p-8 border transition-all duration-700 ease-out hover:-translate-y-2 hover:scale-[1.02] ${
          isHighlighted 
            ? 'border-[#F48CA7] shadow-xl shadow-[#F48CA7]/10 hover:shadow-2xl hover:shadow-[#F48CA7]/20' 
            : 'border-[#F48CA7]/20 shadow-lg hover:shadow-2xl hover:border-[#F48CA7]/40'
        }`}
      >
          ...
          <>
            ...
            <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none">
              <div 
                ...
                style={{ 
                  background: 'linear-gradient(135deg, transparent, #F48CA7, transparent)',
                  padding: '2px',
        ...
        <div className="mb-4">
          <span className={`text-4xl md:text-5xl lg:text-6xl font-extrabold transition-all duration-700 group-hover:scale-110 ${
            isHighlighted 
              ? 'text-[#F48CA7] group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:text-transparent'
              : 'text-[#6B5E58]'
          }`}
          style={isHighlighted ? {
            '--tw-gradient-from': '#F48CA7',
            '--tw-gradient-to': '#C5536C'
          } : {}}>
            {animatedValue ? (
              <AnimatedCounter
        ...
        <h3 className="text-lg font-bold text-[#6B5E58] mb-3 group-hover:text-[#F48CA7] transition-colors duration-500">
          {label}
        </h3>
        ...
        {isHighlighted && (
          <div className="absolute inset-0 overflow-hidden rounded-xl pointer-events-none">
            ...
            />
            <div 
              className="absolute top-1/2 right-8 w-1 h-1 bg-[#F48CA7] rounded-full animate-bounce opacity-30 group-hover:opacity-60"
...
const Results = () => {
  ...
  const resultsData = [
    { 
      value: '×3.2',
      animatedValue: { end: 3, suffix: '.2×', prefix: '' },
      label: 'рост числа отзывов', 
      description: 'на Яндекс.Картах, Google и beauty-платформах',
      icon: (
    ...
    { 
      value: '+1.4',
      animatedValue: { end: 1, suffix: '.4', prefix: '+' },
      label: 'пункта к рейтингу', 
      description: 'в среднем, что выводит салон в топ поиска',
      icon: (
    ...
    { 
      value: '74%',
      animatedValue: { end: 74, suffix: '%', prefix: '' },
      label: 'клиенток отвечают', 
      description: 'на запрос в WhatsApp, в отличие от 6% в email',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
    ...
    { 
      value: '+42%',
      animatedValue: { end: 42, suffix: '%', prefix: '+' },
      label: 'возвратов на процедуры', 
  ...
  return (
    <section 
      ref={sectionRef} 
      id="results" 
      className="py-20 md:py-24 bg-gradient-to-br from-[#F48CA7] to-[#C5536C] text-white relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className={`text-lg text-white/80 leading-relaxed transition-all duration-1000 ${
            ...
            Наши клиентки видят рост ключевых показателей уже в первый месяц использования Beauty Mind.
          </p>
        </div>
          ...
          <div className="relative max-w-4xl mx-auto group">
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                >
                  <svg className="w-5 h-5 text-[#6B5E58]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              ...
              <p className="text-lg text-white/90 leading-relaxed">
                Салоны красоты, использующие Beauty Mind, получают на{' '}
                <span 
                  className="font-bold"
                  style={{ color: '#EECFAE' }}
                >
                ...
                в среднем благодаря автоматизации клиентских отношений.
              </p>
            </div>
          </div>
        </div>
