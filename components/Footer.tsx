  ...
  return (
    <footer className="bg-white border-t border-slate-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-16 md:py-18 relative z-10">
        ...
        {/* Main content - ИСПРАВЛЕННАЯ сетка: 5+7=12 */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          
          {/* Brand section - 5 колонок */}
          <div className="lg:col-span-5">
            <div className="flex items-center mb-6">
              <LogoIcon className="h-8 w-auto mr-3 text-[#fba4ba]" />
              <span 
            ...
            {/* Улучшенное описание для Beauty Mind */}
            <p className="text-slate-700 text-base leading-relaxed mb-8 max-w-md font-medium">
              Автоматизируем работу с клиентами для салонов красоты через WhatsApp.{' '}
              <span 
            ...
            <div className="space-y-3">
              <a 
                ...
                className="flex items-center gap-3 text-slate-700 hover:text-[#fba4ba] transition-colors duration-300"
              >
                <div 
                  className="w-7 h-7 rounded-lg flex items-center justify-center"
                  style={{ backgroundColor: 'rgba(251, 164, 186, 0.1)' }}
                >
                  <svg className="w-3.5 h-3.5 text-[#fba4ba]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {/* Navigation - 7 колонок в 3 блока */}
          <div className="lg:col-span-7">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              
              {/* Product links */}
              <div>
                <h3 className="text-xs font-bold text-[#fba4ba] uppercase tracking-wider mb-5">
                  Продукт
                </h3>
                <ul className="space-y-3">
                  <li>
                    <a
                      ...
                      className="text-sm text-slate-700 hover:text-[#fba4ba] transition-colors duration-300 font-medium"
                    >
                      Решения
                    </a>
                  </li>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a 
                      ...
                      className="text-sm text-slate-700 hover:text-[#fba4ba] transition-colors duration-300 font-medium flex items-center gap-2"
                    >
                      Статус сервиса
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                <a 
                  ...
                  className="text-slate-400 hover:text-[#fba4ba] transition-colors duration-300"
                  aria-label="Telegram"
                >
            ...
            <div className="flex items-center gap-2">
              <div 
                ...
                style={{ backgroundColor: '#f3db9c' }}
              />
              <span className="text-xs text-slate-500 font-medium">
                Сделано для салонов красоты с заботой
              </span>
            </div>
          </div>
